...
SECRET_KEY = 'django-insecure-12qzow7ccsj4xp^@m9yrxps3is6znbf73ksg@&86v6y7jy1^m^'
...
CORS_ALLOWED_ORIGINS = [
    "https://example.com", # domain setup example
    "https://sub.example.com", # subdomain setup example
    "http://localhost:8080",
    "http://127.0.0.1:9000",
]
...
DEFAULT_FROM_EMAIL = 'Nepalit GPT<sureshlama275@gmail.com>'